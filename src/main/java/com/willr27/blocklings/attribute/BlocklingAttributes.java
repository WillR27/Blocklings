...
public class BlocklingAttributes implements IReadWriteNBT
{
    ...
    public BlocklingAttributes(@Nonnull BlocklingEntity blockling)
    {
        ...
        addModifier(mainHandAttackDamageSkillSharpnessModifier = new FloatAttributeModifier("b27747e9-7e73-416f-bb1f-8853b4132e90", "main_hand_attack_damage_skill_sharpness", mainHandAttackDamage, blockling, 5.0f, Operation.ADD, null, () -> skillDisplayNameProvider(CombatSkills.SHARPNESS), false));
        addModifier(mainHandAttackDamageSkillBerserkerModifier = new FloatAttributeModifier("2d1bc0b1-53cc-46e7-8a15-93c3bb538cdc", "main_hand_attack_damage_skill_berserker", mainHandAttackDamage, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(CombatSkills.BERSERKER), false));
        addModifier(mainHandAttackDamageSkillWrecklessModifier = new FloatAttributeModifier("39b9820d-1805-484e-8bf0-9de9e12a878c", "main_hand_attack_damage_skill_wreckless", mainHandAttackDamage, blockling, 10.0f, Operation.ADD, null, () -> skillDisplayNameProvider(CombatSkills.WRECKLESS), false));
        ...
        addModifier(offHandAttackDamageSkillSharpnessModifier = new FloatAttributeModifier("70dcb0be-badc-4e9b-9c64-c94f72ca0686", "off_hand_attack_damage_skill_sharpness", offHandAttackDamage, blockling, 5.0f, Operation.ADD, null, () -> skillDisplayNameProvider(CombatSkills.SHARPNESS), false));
        addModifier(offHandAttackDamageSkillBerserkerModifier = new FloatAttributeModifier("ac55dffa-5403-4a9e-b475-80a07e4e393b", "off_hand_attack_damage_skill_berserker", offHandAttackDamage, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(CombatSkills.BERSERKER), false));
        addModifier(offHandAttackDamageSkillWrecklessModifier = new FloatAttributeModifier("017c8124-108a-40f3-b801-bb7ea448fb9b", "off_hand_attack_damage_skill_wreckless", offHandAttackDamage, blockling, 10.0f, Operation.ADD, null, () -> skillDisplayNameProvider(CombatSkills.WRECKLESS), false));
        ...
        addModifier(attackSpeedSkillMomentumModifier = new FloatAttributeModifier("b97dcf6f-d1e4-4988-aa42-819e79af4a02", "attack_speed_skill_momentum", attackSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(CombatSkills.MOMENTUM), false));
        addModifier(attackSpeedSkillPhotophileModifier = new FloatAttributeModifier("8f7b5867-918a-46b0-bcfb-6ae470220171", "attack_speed_skill_photophile", attackSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(CombatSkills.PHOTOPHILE), false));
        ...
        addModifier(miningSpeedSkillEfficiencyModifier = new FloatAttributeModifier("9464fc16-0f3c-438f-ac0b-8715a3542aaa", "mining_speed_skill_efficiency", miningSpeed, blockling, 1.1f, Operation.MULTIPLY_TOTAL, (v) -> String.format("%.0f%%", (v - 1.0f) * 100.0f), () -> skillDisplayNameProvider(MiningSkills.EFFICIENCY), false));
        addModifier(miningSpeedSkillAdrenalineModifier = new FloatAttributeModifier("1543fadc-3a9e-412b-819b-a6379a0911ca", "mining_speed_skill_adrenaline", miningSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(MiningSkills.ADRENALINE), false));
        addModifier(miningSpeedSkillMomentumModifier = new FloatAttributeModifier("1ca4d69f-05b8-4598-97c5-95f6bc750b7a", "mining_speed_skill_momentum", miningSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(MiningSkills.MOMENTUM), false));
        addModifier(miningSpeedSkillHastyModifier = new FloatAttributeModifier("035c4e96-a628-4b20-9699-28ade0fa5a80", "mining_speed_skill_hasty", miningSpeed, blockling, 10.0f, Operation.ADD, null, () -> skillDisplayNameProvider(MiningSkills.HASTY), false));
        addModifier(miningSpeedSkillNightOwlModifier = new FloatAttributeModifier("f858c34f-d215-450a-847d-a54525d2f82f", "mining_speed_skill_night_owl", miningSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(MiningSkills.NIGHT_OWL), false));
        ...
        addModifier(woodcuttingSpeedSkillEfficiencyModifier = new FloatAttributeModifier("38a9d80c-4f96-4929-bd34-8c03156dec6d", "woodcutting_speed_skill_efficiency", woodcuttingSpeed, blockling, 1.1f, Operation.MULTIPLY_TOTAL, (v) -> String.format("%.0f%%", (v - 1.0f) * 100.0f), () -> skillDisplayNameProvider(WoodcuttingSkills.EFFICIENCY), false));
        addModifier(woodcuttingSpeedSkillAdrenalineModifier = new FloatAttributeModifier("e832c5da-0465-4a63-96b7-398eb32ba206", "woodcutting_speed_skill_adrenaline", woodcuttingSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(WoodcuttingSkills.ADRENALINE), false));
        addModifier(woodcuttingSpeedSkillMomentumModifier = new FloatAttributeModifier("868bba90-a29c-4b70-b599-c3f56b00928e", "woodcutting_speed_skill_momentum", woodcuttingSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(WoodcuttingSkills.MOMENTUM), false));
        addModifier(woodcuttingSpeedSkillHastyModifier = new FloatAttributeModifier("38709558-3da6-4f86-896f-195e84c18525", "woodcutting_speed_skill_hasty", woodcuttingSpeed, blockling, 10.0f, Operation.ADD, null, () -> skillDisplayNameProvider(WoodcuttingSkills.HASTY), false));
        addModifier(woodcuttingSpeedSkillNightOwlModifier = new FloatAttributeModifier("adbe5ab0-4a08-4335-a68a-964b9126c40f", "woodcutting_speed_skill_night_owl", woodcuttingSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(WoodcuttingSkills.NIGHT_OWL), false));
        ...
        addModifier(farmingSpeedSkillEfficiencyModifier = new FloatAttributeModifier("792be316-19cb-49ec-a24a-ee224312c60f", "farming_speed_skill_efficiency", farmingSpeed, blockling, 1.1f, Operation.MULTIPLY_TOTAL, (v) -> String.format("%.0f%%", (v - 1.0f) * 100.0f), () -> skillDisplayNameProvider(FarmingSkills.EFFICIENCY), false));
        addModifier(farmingSpeedSkillAdrenalineModifier = new FloatAttributeModifier("79f7d5ff-2fd7-4385-a795-c281f984445b", "farming_speed_skill_adrenaline", farmingSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(FarmingSkills.ADRENALINE), false));
        addModifier(farmingSpeedSkillMomentumModifier = new FloatAttributeModifier("d58d5336-d2fe-447d-a237-bb0bbff313d7", "farming_speed_skill_momentum", farmingSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(FarmingSkills.MOMENTUM), false));
        addModifier(farmingSpeedSkillHastyModifier = new FloatAttributeModifier("3f045e39-8185-4d2c-8980-54e06f8d548b", "farming_speed_skill_hasty", farmingSpeed, blockling, 10.0f, Operation.ADD, null, () -> skillDisplayNameProvider(FarmingSkills.HASTY), false));
        addModifier(farmingSpeedSkillNightOwlModifier = new FloatAttributeModifier("451f37a9-649e-44a3-a21f-d76e49f1afd0", "farming_speed_skill_night_owl", farmingSpeed, blockling, 0.0f, Operation.ADD, null, () -> skillDisplayNameProvider(FarmingSkills.NIGHT_OWL), false));
    }
