...
public class BlocklingSpawnEgg extends SpawnEggItem
{
    protected static final List<BlocklingSpawnEgg> UNADDED_EGGS = new ArrayList<>();

    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public BlocklingSpawnEgg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, int primaryColour, int secondaryColour, Properties properties)
    {
