...
import com.willr27.blocklings.goal.goals.target.BlocklingGatherTargetGoalOLD;
 ...
 * @param <T>
 */
public abstract class BlocklingGatherGoalOLD<T extends BlocklingGatherTargetGoalOLD<?>> extends BlocklingGoal implements IHasTargetGoalOLD<T>
{
    /**
     ...
     */
    public BlocklingGatherGoalOLD(UUID id, BlocklingEntity blockling, BlocklingTasks tasks)
    {
