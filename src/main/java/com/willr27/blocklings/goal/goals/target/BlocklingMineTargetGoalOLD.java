...
import com.willr27.blocklings.goal.goals.BlocklingMineGoalOLD;
 ...
 */
public class BlocklingMineTargetGoalOLD extends BlocklingGatherTargetGoalOLD<BlocklingMineGoalOLD>
{
    /**
     ...
     */
    public BlocklingMineTargetGoalOLD(@Nonnull BlocklingMineGoalOLD goal)
    {
        super(goal);
    }
