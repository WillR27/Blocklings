...
import com.willr27.blocklings.goal.goals.BlocklingFarmGoalOLD;
 ...
 */
public class BlocklingFarmTargetGoalOLD extends BlocklingGatherTargetGoalOLD<BlocklingFarmGoalOLD>
{
    /**
     ...
     */
    public BlocklingFarmTargetGoalOLD(@Nonnull BlocklingFarmGoalOLD goal)
    {
        super(goal);
    }
