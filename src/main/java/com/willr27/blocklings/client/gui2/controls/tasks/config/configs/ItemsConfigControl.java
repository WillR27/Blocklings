...
import com.willr27.blocklings.client.gui2.controls.common.panel.FlowPanelControl;
...
//        itemsPanel.setMargin(Side.TOP, 3);
//        itemsPanel.setPadding(5, 5, 5, 5);
        ...
        new AddItemControl(itemsPanel);

        for (int i = 0; i < 6; i++)
        {
            for (Block block : BlockUtil.ORES.get())
            {
                new ItemControl(itemsPanel, block.asItem());
            }
        }
    }
