...
public class GuiTextFieldCentered extends Gui
{
    ...
    private String text = "";
    private int maxStringLength = 22;
    ...
    public GuiTextFieldCentered(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
        ...
        this.baseWidth = par5Width;
        this.height = par6Height;
        this.baseHeight = par6Height;
    ...
    public void updateCursorCounter()
    {
        ...
        this.width = fontRenderer.getStringWidth(text) + 20;
        this.x = baseX + baseWidth / 2 + 6;
        this.x -= width / 2;
    }
